...
SEASON_SPECS: list[tuple[str, str, str]] = [
    # ("winter", "2021-01-01 00:00:00", "2021-03-31 23:00:00"),
    ("winter", "2021-10-01 00:00:00", "2021-12-31 23:00:00"),
    # ("summer", "2021-06-15 00:00:00", "2021-09-15 23:00:00"),
]
# ------------------------------------------------------------
...
def plot_season_overlay(
    ...
    ax.set_title(f"Median total heating demand across all variants – {label}")
    ax.set_xlabel("Time")
