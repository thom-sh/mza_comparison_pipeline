...
def plot_windowed_overlay_all_three(
    ...
    ax.set_title(f"P5, P50 and P95 total heating demand across all variants – {label.replace('_', ' ')}")
    ax.set_xlabel("Time")
...
def main() -> None:
    ...
    for label, duration in WINDOW_SPECS:
        saved.append(plot_windowed_overlay_all_three(quantiles_by_variant, counts_by_variant, label, duration))
        saved.append(
