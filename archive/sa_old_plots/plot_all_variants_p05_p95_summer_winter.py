...
def plot_season_overlay_both(
    ...
    ax.set_title(f"P5 and P95 total heating demand across all variants – {label}")
    ax.set_xlabel("Time")
...
def main() -> None:
    ...
    for label, start_str, end_str in SEASON_SPECS:
        saved.append(plot_season_overlay_both(quantiles_by_variant, counts_by_variant, label, start_str, end_str))
        saved.append(
