...
KPI_CONFIGS = [
    {
        ...
        "xlabel": r"Morris $\mu^\ast$ in MWh",
        "scatter_xlabel": r"Morris $\mu^\ast$ in MWh",
        "scatter_ylabel": r"Morris $\sigma$ in MWh",
    ...
    },
    {
        ...
        "xlabel": r"Morris $\mu^\ast$ in kW",
        "scatter_xlabel": r"Morris $\mu^\ast$ in kW",
        "scatter_ylabel": r"Morris $\sigma$ in kW",
    ...
    # Otherwise, the script will automatically skip it.
    {
        ...
        "xlabel": r"Morris $\mu^\ast$ in h",
        "scatter_xlabel": r"Morris $\mu^\ast$ in h",
        "scatter_ylabel": r"Morris $\sigma$ in h",
        "transform": lambda s: s,
