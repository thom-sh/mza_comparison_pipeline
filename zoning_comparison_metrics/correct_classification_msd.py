...
# CONFIG
# ===============================================================
DIAGNOSTIC_CSV = r"C:\WF\Thomas Sharon\Floorplan_Dataset\comparison_logic\diagnostic_table_with_topology_200.csv"

OUT_CATEGORY_IDS_CSV = r"C:\WF\Thomas Sharon\Floorplan_Dataset\comparison_logic\diagnostic_category_building_ids_200.csv"
OUT_CATEGORY_IDS_TXT = r"C:\WF\Thomas Sharon\Floorplan_Dataset\comparison_logic\diagnostic_category_building_ids_200.txt"
...
for category in categories:
    ...
    building_ids = (
    pd.to_numeric(subset["building_id"], errors="coerce")
    .dropna()
    .astype(int)
    .sort_values()
    .tolist()
