...
def main():
    ...
    # -----------------------------------------------------------
    GT_ROOT = r"C:\WF\Thomas Sharon\Floorplan_Dataset\rd_pickle"
    PRED_ROOT = r"C:\WF\Thomas Sharon\Floorplan_Dataset\gml_rd\building_data"

    DIAGNOSTIC_CSV = (
        r"C:\WF\Thomas Sharon\Floorplan_Dataset\gml_rd"
        r"\comparison_output\diagnostic_table_with_topology_rd_final.csv"
    )

    OUTPUT_DIR = (
        r"C:\WF\Thomas Sharon\Floorplan_Dataset\gml_rd"
        r"\comparison_output\figures"
    )
    ...
    output_good_pdf = os.path.join(
        OUTPUT_DIR,
        "successful_reference_prediction_overlays_rd.pdf",
    )
    ...
    FAILURE_CASES_6 = {
        "Structural mismatch 1": 20,
        "Structural mismatch 2": 39,
        "Structural mismatch 3": 52,
        "Structural mismatch 4": 53,
        "Over-zoned": 1,
        "High area error / shifted zones": 47,
    }
    ...
    output_failure_pdf = os.path.join(
        OUTPUT_DIR,
        "failure_reference_prediction_overlays_rd.pdf",
    )
